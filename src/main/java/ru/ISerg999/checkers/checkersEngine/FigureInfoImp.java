...
public class FigureInfoImp implements FigureInfo {
    ...
    // Константы.
    public static final int CONST_MAX_COLOR = 2;
    public static final int CONST_MAX_FIGURE = 2;
    public static final int CONST_COLOR_WHITE = 1;
    public static final int CONST_COLOR_BLACK = 0;
    public static final int CONST_FIGURE_CHECKERS = 2;
    public static final int CONST_FIGURE_QUEEN = 4;
